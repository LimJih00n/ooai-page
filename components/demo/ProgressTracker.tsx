...
export default function ProgressTracker({ steps, currentStep, isRunning, isComplete }: ProgressTrackerProps) {
  return (
          ...
          return (
            <React.Fragment key={step.id}>
              <div className="flex flex-col items-center">
                ...
                <p className={`mt-2 text-xs text-center font-semibold ${isActive || isCompleted ? 'text-blue-600' : 'text-gray-500'}`}>
                  {step.name}
                </p>
              </div>
