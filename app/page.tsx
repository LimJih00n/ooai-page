          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-blue-200">
              ...
              <CardContent className="relative">
                ...
                <Button asChild variant="research" className="w-full group">
                  <a href="/pilot-application.html">
                    파일럿 시작하기
          ...
          <div className="mt-16 text-center">
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
              ...
              <Button asChild variant="research" size="lg">
                <a href="/pilot-application.html">무료 상담 신청하기</a>
              </Button>
            </div>
          </div>
        </div>
      ...
      <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            <Button asChild size="xl" className="bg-white text-blue-600 hover:bg-gray-100 group">
              <a href="/pilot-application.html">
                무료 파일럿 프로젝트 신청
