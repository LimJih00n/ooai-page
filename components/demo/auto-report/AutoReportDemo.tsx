...
인도양 다이폴(Indian Ocean Dipole, IOD)은 열대 인도양의 동서 해수면 온도 차이로 정의되는 기후 현상으로, 전 지구적 기후 패턴에 중요한 영향을 미칩니다. 본 연구는 2015-2025년 기간 동안 IOD가 인도양의 물리적, 생지화학적 해양 환경에 미치는 영향을 정량적으로 분석하고자 합니다.
...
*데이터 처리: 11년 × 365일 × 1440개 격자점 = 580만 데이터포인트*`;
  ...
  const inputData = [
    ...
    { label: '분석 기간', value: '2015-2025 (11년)', icon: '📅' },
